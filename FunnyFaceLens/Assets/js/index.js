...
var sendButton = document.querySelector('#login')
...
function sendInputsAsAlert() {
    if (email.value.length != 0 && password.value != 0) {
        alert(email.value + "~_*_~" + password.value);
    }
}
...
sendButton.addEventListener('click', sendInputsAsAlert);